...
type HyperspeedEffectOptions = Partial<
  Omit<HyperspeedOptions, "colors" | "distortion">
> & {
  distortion?: string | Distortion;
...
const Hyperspeed: FC<HyperspeedProps> = ({
  ...
  useEffect(() => {
    ...
    const lightColors: Colors = {
      roadColor: 0xf8fafd,
      islandColor: 0xeef2f7,
      background: 0xf8fafd,
      shoulderLines: 0x64748d,
      brokenLines: 0x94a3b8,
      leftCars: [0x533afd, 0x0073e6, 0x425466],
      rightCars: [0x533afd, 0x0073e6, 0x64748d],
      sticks: 0x533afd,
    };
